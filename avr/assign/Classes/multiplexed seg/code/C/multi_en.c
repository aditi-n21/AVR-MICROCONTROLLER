...
#define msec 1
unsigned int num=0;
sbit dig_ctrl_4=P1^3;  //Declare the control or enable pins of seven segments
...
void delay()  //To provide delay a small time delay 
{
    TMOD=0x01;
    TL0=0x36;
    TH0=0xF6;
...
void display() interrupt 1  // Function to display the digits on seven segmnet. For more details refer seven segment multiplexing.
{
TL0=0x36;
    TH0=0xf6;
P2=0xFF;
