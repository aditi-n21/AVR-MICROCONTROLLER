...
void main()
{
 ...
 TMOD = 0x20;
	...
	cmd_lcd(0x80);
		...
		cmd_lcd(0x01);
		cmd_lcd(0x80);
		display_lcd("MANISHA,ARIBA");
		cmd_lcd(0xc0);
		display_lcd("RUCHI & VIVEK ");
delay(20);
	cmd_lcd(0x01);
 while(1)
 { 
